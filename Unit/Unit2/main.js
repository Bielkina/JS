...
document.querySelector('.out-2').textContent = res2;
...
document.querySelector('.out-3').textContent = res3;
...
document.querySelector('.out-4').textContent = res4;
//Спрацювало правило додавання рядка '3' до числа 5
...
document.querySelector('.out-5').textContent = res5;
console.log(res5);
...
document.querySelector('.out-6').textContent = res6;
...
document.querySelector('.out-7').textContent = res7;
...
function t9() {
    ...
    let clean = document.querySelector(".i-9").value = '';
...
function t13() {
    let i131 = +document.querySelector('.i-13-1').value;
    let i132 = +document.querySelector('.i-13-2').value;
    let out = document.querySelector('.out-13');
    out.innerHTML = i131 + i132;
}
...
function t14() {
    let i14go = document.querySelector(".i-14").value = 'Go';
    i14go.innerHTML = 'Go';
}

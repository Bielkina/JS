...
function f7(){
   ...
   out.innerHTML = Math.pow(i71, i72);
...
function f8() {
   ...
   switch(s8) {
      ...
      case '3':
         ...
         break;
      default:
         out.innerHTML = 'Неверное значение';   
   }
}
